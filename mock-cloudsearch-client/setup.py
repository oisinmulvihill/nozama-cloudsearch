# -*- coding: utf-8 -*-
"""
Setuptools script for mock-cloudsearch-client (mock.cloudsearch.client)
...
Name = 'mock-cloudsearch-client'
ProjectUrl = ""
Version = version
Author = ''
AuthorEmail = 'everyone at body dot co dot uk'
Maintainer = ''
Summary = ' mock-cloudsearch-client '
License = ''
Description = Summary
...
test_suite = 'mock.cloudsearch.client.tests'
...
EntryPoints = {
    'console_scripts': [
        'cloudsearch-admin = mock.cloudsearch.client.admintool:main',
    ],
}
