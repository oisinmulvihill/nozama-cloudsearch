# -*- coding: utf-8 -*-
"""
Setuptools script for mock-cloudsearch-common (mock.cloudsearch.common)
...
Name = 'mock-cloudsearch-common'
ProjectUrl = ""
Version = version
Author = ''
AuthorEmail = 'everyone at body dot co dot uk'
Maintainer = ''
Summary = ' mock-cloudsearch-common '
License = ''
Description = Summary
...
test_suite = 'mock.cloudsearch.common.tests'
...
ProjectScripts = [
    #'mock.cloudsearch.common/scripts/somescript',
]
