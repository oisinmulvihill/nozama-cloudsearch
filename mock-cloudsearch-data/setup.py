        # -*- coding: utf-8 -*-
"""
Setuptools script for mock-cloudsearch-data (mock.cloudsearch.data)
...
Name = 'mock-cloudsearch-data'
ProjectUrl = ""
Version = version
Author = ''
AuthorEmail = 'everyone at body dot co dot uk'
Maintainer = ''
Summary = ' mock-cloudsearch-data '
License = ''
Description = Summary
...
test_suite = 'mock.cloudsearch.data.tests'
